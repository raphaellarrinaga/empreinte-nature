 ...
 */
class fasterImage_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends fasterImage_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new fasterImage_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
