 ...
 */
class fasterImage_AdminPageFramework_FieldType_checkbox extends fasterImage_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        $_oCheckbox = new fasterImage_AdminPageFramework_Input_checkbox($aField['attributes']);
