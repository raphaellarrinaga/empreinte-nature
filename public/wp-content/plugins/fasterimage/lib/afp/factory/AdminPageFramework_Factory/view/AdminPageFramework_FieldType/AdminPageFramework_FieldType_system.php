 ...
 */
class fasterImage_AdminPageFramework_FieldType_system extends fasterImage_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    private function _getClientInfo($bGenerateInfo = true) {
        ...
        return empty($_aBrowser) ? __('No browser information found.', 'fasterimage') : $_aBrowser;
    }
    ...
    private function _getSiteInfo() {
        global $wpdb;
        return array(__('Version', 'fasterimage') => $GLOBALS['wp_version'], __('Language', 'fasterimage') => $this->getSiteLanguage(), __('Memory Limit', 'fasterimage') => $this->getReadableBytes($this->getNumberOfReadableSize(WP_MEMORY_LIMIT)), __('Multi-site', 'fasterimage') => $this->getAOrB(is_multisite(), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Permalink Structure', 'fasterimage') => get_option('permalink_structure'), __('Active Theme', 'fasterimage') => $this->_getActiveThemeName(), __('Registered Post Statuses', 'fasterimage') => implode(', ', get_post_stati()), 'WP_DEBUG' => $this->getAOrB($this->isDebugModeEnabled(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), 'WP_DEBUG_LOG' => $this->getAOrB($this->isDebugLogEnabled(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), 'WP_DEBUG_DISPLAY' => $this->getAOrB($this->isDebugDisplayEnabled(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), __('Table Prefix', 'fasterimage') => $wpdb->prefix, __('Table Prefix Length', 'fasterimage') => strlen($wpdb->prefix), __('Table Prefix Status', 'fasterimage') => $this->getAOrB(strlen($wpdb->prefix) > 16, $this->oMsg->get('too_long'), $this->oMsg->get('acceptable')), 'wp_remote_post()' => $this->_getWPRemotePostStatus(), 'wp_remote_get()' => $this->_getWPRemoteGetStatus(), __('Multibite String Extension', 'fasterimage') => $this->getAOrB(function_exists('mb_detect_encoding'), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), __('WP_CONTENT_DIR Writeable', 'fasterimage') => $this->getAOrB(is_writable(WP_CONTENT_DIR), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Active Plugins', 'fasterimage') => PHP_EOL . $this->_getActivePlugins(), __('Network Active Plugins', 'fasterimage') => PHP_EOL . $this->_getNetworkActivePlugins(), __('Constants', 'fasterimage') => $this->_getDefinedConstants('user'),);
    }
    ...
    private function _getPHPInfo($bGenerateInfo = true) {
        ...
        $_oErrorReporting = new fasterImage_AdminPageFramework_ErrorReporting;
        self::$_aPHPInfo = array(__('Version', 'fasterimage') => phpversion(), __('Safe Mode', 'fasterimage') => $this->getAOrB(@ini_get('safe_mode'), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Memory Limit', 'fasterimage') => @ini_get('memory_limit'), __('Upload Max Size', 'fasterimage') => @ini_get('upload_max_filesize'), __('Post Max Size', 'fasterimage') => @ini_get('post_max_size'), __('Upload Max File Size', 'fasterimage') => @ini_get('upload_max_filesize'), __('Max Execution Time', 'fasterimage') => @ini_get('max_execution_time'), __('Max Input Vars', 'fasterimage') => @ini_get('max_input_vars'), __('Argument Separator', 'fasterimage') => @ini_get('arg_separator.output'), __('Allow URL File Open', 'fasterimage') => $this->getAOrB(@ini_get('allow_url_fopen'), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Display Errors', 'fasterimage') => $this->getAOrB(@ini_get('display_errors'), $this->oMsg->get('on'), $this->oMsg->get('off')), __('Log Errors', 'fasterimage') => $this->getAOrB(@ini_get('log_errors'), $this->oMsg->get('on'), $this->oMsg->get('off')), __('Error log location', 'fasterimage') => @ini_get('error_log'), __('Error Reporting Level', 'fasterimage') => $_oErrorReporting->getErrorLevel(), __('FSOCKOPEN', 'fasterimage') => $this->getAOrB(function_exists('fsockopen'), $this->oMsg->get('supported'), $this->oMsg->get('not_supported')), __('cURL', 'fasterimage') => $this->getAOrB(function_exists('curl_init'), $this->oMsg->get('supported'), $this->oMsg->get('not_supported')), __('SOAP', 'fasterimage') => $this->getAOrB(class_exists('SoapClient'), $this->oMsg->get('supported'), $this->oMsg->get('not_supported')), __('SUHOSIN', 'fasterimage') => $this->getAOrB(extension_loaded('suhosin'), $this->oMsg->get('supported'), $this->oMsg->get('not_supported')), 'ini_set()' => $this->getAOrB(function_exists('ini_set'), $this->oMsg->get('supported'), $this->oMsg->get('not_supported')),) + $this->getPHPInfo() + array(__('Constants', 'fasterimage') => $this->_getDefinedConstants(null, 'user'));
        return self::$_aPHPInfo;
    }
    private function _getWebServerInfo($bGenerateInfo = true) {
        return $bGenerateInfo ? array(__('Web Server', 'fasterimage') => $_SERVER['SERVER_SOFTWARE'], 'SSL' => $this->getAOrB(is_ssl(), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Session', 'fasterimage') => $this->getAOrB(isset($_SESSION), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), __('Session Name', 'fasterimage') => esc_html(@ini_get('session.name')), __('Session Cookie Path', 'fasterimage') => esc_html(@ini_get('session.cookie_path')), __('Session Save Path', 'fasterimage') => esc_html(@ini_get('session.save_path')), __('Session Use Cookies', 'fasterimage') => $this->getAOrB(@ini_get('session.use_cookies'), $this->oMsg->get('on'), $this->oMsg->get('off')), __('Session Use Only Cookies', 'fasterimage') => $this->getAOrB(@ini_get('session.use_only_cookies'), $this->oMsg->get('on'), $this->oMsg->get('off')),) + $_SERVER : '';
    }
}