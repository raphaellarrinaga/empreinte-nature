 ...
 */
abstract class fasterImage_AdminPageFramework_Form_Model_Export extends fasterImage_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new fasterImage_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
