 ...
 */
abstract class fasterImage_AdminPageFramework_MetaBox_Router extends fasterImage_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'fasterimage') {
        if (empty($asPostTypeOrScreenID)) {
            return;
        }
        $_sClassName = get_class($this);
        parent::__construct(isset($this->oProp) ? $this->oProp : new fasterImage_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
