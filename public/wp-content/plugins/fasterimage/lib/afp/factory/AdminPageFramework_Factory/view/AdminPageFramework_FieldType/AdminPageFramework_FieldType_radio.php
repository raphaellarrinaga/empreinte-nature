 ...
 */
class fasterImage_AdminPageFramework_FieldType_radio extends fasterImage_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new fasterImage_AdminPageFramework_Input_radio($aField['attributes']);
