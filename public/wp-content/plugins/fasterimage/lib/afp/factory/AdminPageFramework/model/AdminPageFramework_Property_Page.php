 ...
 */
class fasterImage_AdminPageFramework_Property_Page extends fasterImage_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'fasterimage') {
        ...
        $GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['afasterImage_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['afasterImage_AdminPageFramework']['aPageClasses']) ? $GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
