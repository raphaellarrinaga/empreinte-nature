 ...
 */
abstract class fasterImage_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $this->sTextDomain = $this->oUtil->getAOrB(empty($sTextDomain), 'fasterimage', $sTextDomain);
        $this->sFieldsType = $sFieldsType;
        $GLOBALS['afasterImage_AdminPageFramework'] = isset($GLOBALS['afasterImage_AdminPageFramework']) && is_array($GLOBALS['afasterImage_AdminPageFramework']) ? $GLOBALS['afasterImage_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => fasterImage_AdminPageFramework_Registry::NAME, 'sURI' => fasterImage_AdminPageFramework_Registry::URI, 'sScriptName' => fasterImage_AdminPageFramework_Registry::NAME, 'sLibraryName' => fasterImage_AdminPageFramework_Registry::NAME, 'sLibraryURI' => fasterImage_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => fasterImage_AdminPageFramework_Registry::getVersion(), 'sDescription' => fasterImage_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => fasterImage_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => fasterImage_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => fasterImage_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => fasterImage_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : fasterImage_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
