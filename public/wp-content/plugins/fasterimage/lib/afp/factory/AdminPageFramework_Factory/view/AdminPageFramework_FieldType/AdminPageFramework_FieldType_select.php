 ...
 */
class fasterImage_AdminPageFramework_FieldType_select extends fasterImage_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new fasterImage_AdminPageFramework_Input_select($aField['attributes']);
