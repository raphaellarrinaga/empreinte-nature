 ...
 */
class fasterImage_AdminPageFramework_Property_MetaBox_Page extends fasterImage_AdminPageFramework_Property_MetaBox {
    public $_sPropertyType = 'page_meta_box';
    public $aPageSlugs = array();
    public $oAdminPage;
    public $aHelpTabs = array();
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'fasterimage', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['afasterImage_AdminPageFramework']['aPageClasses'] as $__oClass) {
