 ...
 */
abstract class fasterImage_AdminPageFramework_Form_Model_Import extends fasterImage_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new fasterImage_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
