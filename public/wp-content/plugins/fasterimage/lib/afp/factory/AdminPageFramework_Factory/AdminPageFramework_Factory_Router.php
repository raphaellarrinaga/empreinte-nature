 ...
 */
abstract class fasterImage_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $_aFormElementClassNameMap = array('page' => 'fasterImage_AdminPageFramework_FormElement_Page', 'network_admin_page' => 'fasterImage_AdminPageFramework_FormElement_Page', 'post_meta_box' => 'fasterImage_AdminPageFramework_FormElement_Meta', 'page_meta_box' => 'fasterImage_AdminPageFramework_FormElement', 'post_type' => 'fasterImage_AdminPageFramework_FormElement', 'taxonomy' => 'fasterImage_AdminPageFramework_FormElement', 'widget' => 'fasterImage_AdminPageFramework_FormElement', 'user_meta' => 'fasterImage_AdminPageFramework_FormElement_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'fasterImage_AdminPageFramework_Resource_Page', 'network_admin_page' => 'fasterImage_AdminPageFramework_Resource_Page', 'post_meta_box' => 'fasterImage_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'fasterImage_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'fasterImage_AdminPageFramework_Resource_PostType', 'taxonomy' => 'fasterImage_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'fasterImage_AdminPageFramework_Resource_Widget', 'user_meta' => 'fasterImage_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'fasterImage_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'fasterImage_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'fasterImage_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'fasterImage_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'fasterImage_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'fasterImage_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'fasterImage_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'fasterImage_AdminPageFramework_Link_Page', 'network_admin_page' => 'fasterImage_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'fasterImage_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'fasterImage_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'fasterImage_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'fasterImage_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new fasterImage_AdminPageFramework_WPUtility;
        return $this->oUtil;
    }
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new fasterImage_AdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = fasterImage_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
