 ...
 */
abstract class fasterImage_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('fasterImage_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new fasterImage_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
