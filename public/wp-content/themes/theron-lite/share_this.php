<div class="share_this">
            ...
            <div class="social_buttons">
                ...
                <a href="http://facebook.com/share.php?u=<?php the_permalink() ?>&amp;amp;t=<?php echo urlencode(the_title('','', false)) ?>" title="Share <?php _e('this post on Facebook', 'theron');?>" target="_blank"></a>

                </div>

                <div class="lgn_twt">

                <a href="http://twitter.com/home?status= <?php the_title(); ?> <?php the_permalink();?>" title="Tweet <?php _e('this post', 'theron'); ?>" target="_blank"></a>
