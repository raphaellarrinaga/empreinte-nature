 ...
 */
abstract class fasterImage_AdminPageFramework_Form_View extends fasterImage_AdminPageFramework_Form_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        ...
        $_oField = new fasterImage_AdminPageFramework_FormField($aField, $_aTemp, $this->aFieldErrors, $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
