 ...
 */
abstract class fasterImage_AdminPageFramework_Page_View_MetaBox extends fasterImage_AdminPageFramework_Page_Model {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fasterimage') {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['afasterImage_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['afasterImage_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['afasterImage_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['afasterImage_AdminPageFramework']['bAddedMetaBoxScript'] = true;
