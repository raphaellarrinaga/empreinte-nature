 ...
 */
abstract class fasterImage_AdminPageFramework_Router extends fasterImage_AdminPageFramework_Factory {
    function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'fasterimage') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new fasterImage_AdminPageFramework_Property_Page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
