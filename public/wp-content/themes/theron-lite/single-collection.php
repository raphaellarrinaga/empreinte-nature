...
<ul id="menu_collections_in_ul"><?php $query = new WP_Query( array( 'post_type' => array( 'collection' ) ) );
$link_focused = get_query_var( 'collection' );
 $postb = get_permalink();
...
<div class="single_wrap" id="Div_1" >
