 ...
 */
abstract class fasterImage_AdminPageFramework_FormField_Base extends fasterImage_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new fasterImage_AdminPageFramework_Script_Widget;
        ...
        new fasterImage_AdminPageFramework_Script_Utility;
        new fasterImage_AdminPageFramework_Script_OptionStorage;
        new fasterImage_AdminPageFramework_Script_AttributeUpdator;
        new fasterImage_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new fasterImage_AdminPageFramework_Script_Sortable;
        new fasterImage_AdminPageFramework_Script_RegisterCallback;
    }
