 ...
 */
class fasterImage_AdminPageFramework_FormTable_Base extends fasterImage_AdminPageFramework_FormOutput {
    public function __construct($aFieldTypeDefinitions, array $aFieldErrors, $oMsg = null) {
        ...
        $this->oMsg = $oMsg ? $oMsg : fasterImage_AdminPageFramework_Message::getInstance();
        $this->_loadScripts();
    }
    ...
    private function _loadScripts() {
        ...
        new fasterImage_AdminPageFramework_Script_Tab;
    }
...
JAVASCRIPTS;
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        new fasterImage_AdminPageFramework_Script_CollapsibleSection($this->oMsg);
    }
    ...
    protected function _getRepeatableSectionsEnablerScript($sContainerTagID, $iSectionCount, $aSettings) {
        ...
        new fasterImage_AdminPageFramework_Script_RepeatableSection($this->oMsg);
...
JAVASCRIPTS;
    ...
    protected function _getDebugInfo($sFieldsType) {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . fasterImage_AdminPageFramework_Registry::NAME . ' ' . fasterImage_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}