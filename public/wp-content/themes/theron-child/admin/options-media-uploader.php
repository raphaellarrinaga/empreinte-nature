...
if ( ! function_exists( 'theron_uploader' ) ) :



function theron_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
...
if ( ! function_exists( 'theron_media_scripts' ) ) :



add_action( 'admin_enqueue_scripts', 'theron_media_scripts' );



function theron_media_scripts( $hook ) {
	...
	wp_localize_script( 'of-media-uploader', 'theron_l10n', array(
