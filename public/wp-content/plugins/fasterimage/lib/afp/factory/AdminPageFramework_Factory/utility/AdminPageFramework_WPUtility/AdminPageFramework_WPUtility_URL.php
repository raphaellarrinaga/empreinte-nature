 ...
 */
class fasterImage_AdminPageFramework_WPUtility_URL extends fasterImage_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(fasterImage_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(fasterImage_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = fasterImage_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
