...
//Register Menus
	...
	$labels = array(
		...
		'singular_name'       => _x( 'Réalisations', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'           => __( 'Réalisations', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Réalisations:', 'text_domain' ),
		'all_items'           => __( 'All Réalisations', 'text_domain' ),
		'view_item'           => __( 'View Réalisations', 'text_domain' ),
		'add_new_item'        => __( 'Add New Réalisations', 'text_domain' ),
		'add_new'             => __( 'New Réalisations', 'text_domain' ),
		'edit_item'           => __( 'Edit Réalisations', 'text_domain' ),
		'update_item'         => __( 'Update Réalisations', 'text_domain' ),
		'search_items'        => __( 'Search Réalisations', 'text_domain' ),
		'not_found'           => __( 'No Réalisations found', 'text_domain' ),
		'not_found_in_trash'  => __( 'No Réalisations found in Trash', 'text_domain' ),
	);
	$args = array(
		'label'               => __( 'Réalisations', 'text_domain' ),
		'description'         => __( 'Réalisations information pages', 'text_domain' ),
		'labels'              => $labels,
